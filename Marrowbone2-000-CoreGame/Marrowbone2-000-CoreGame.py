...
def dock():
    ...
    move = input("Where do you go? > ").lower().strip()
...
def trail():
    ...
    print(
        ...
        "Paths lead west into a forest, north to a cliff, or south back to the dock."
    )
